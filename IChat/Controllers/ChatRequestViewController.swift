...
class ChatRequestViewController: UIViewController {
    ...
    let aboutMeLabel = UILabel(text: "You have opportunity to start new chat", font: UIFont.systemFont(ofSize: 16, weight: .light))
    ...
    @objc private func denyButtonTapped() {
        dismiss(animated: true) {
            self.delegate?.rmoveWaitingChat(chat: self.chat)
        }
    }
